...
onmt_translate -model ./model/SoM_identifier/model1.pt ./model/SoM_identifier/model2.pt ./model/SoM_identifier/model3.pt ./model/SoM_identifier/model4.pt -src $SRC_FILE -output $OUT_FILE1 -n_best 5 -beam_size 8 -verbose -min_length 5 -max_length 150 -replace_unk -seed 42 -gpu 0
...
python process_predictions-predict.py -input_file $INPUT_FILE -predictions_file $OUT_FILE2 -output_file $OUT_FILE3 -predict_number 5 -visualise_molecules True
