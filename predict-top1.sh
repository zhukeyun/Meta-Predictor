...
onmt_translate -model ./model/SoM_identifier/mode1.pt ./model/SoM_identifier/mode2.pt ./model/SoM_identifier/mode3.pt ./model/SoM_identifier/mode4.pt -src $SRC_FILE -output $OUT_FILE1 -n_best 1 -beam_size 4 -verbose -min_length 5 -max_length 150 -replace_unk -seed 42 -gpu 0
...
python process_predictions-predict.py -input_file $INPUT_FILE -predictions_file $OUT_FILE2 -output_file $PRED_FILE3 -predict_number 1 
